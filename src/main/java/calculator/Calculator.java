...
public class Calculator {
    ...
    private LinkedList<Double> circleAreaResult; // 원의 넓이 결과를 저장하는 컬렉션 타입의 필드 선언
    ...
    public LinkedList<Double> getCircleAreaResult() { // circleAreaResult getter
        return circleAreaResult;
    }

    public void setCircleAreaResult(LinkedList<Double> circleAreaResult) { // circleAreaResult setter
